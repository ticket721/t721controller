...
module.exports = {
    mint_invalid_authorization_signature: async function mint_invalid_authorization_signature() {
        ...
        const signer = new MintingAuthorizer(network_id * 2, T721Controller.address);
        ...
        await expect(T721Controller.verifyMint(id, 0, mint_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::verifyMint | invalid authorization signature');
        return expect(T721Controller.mint(id, 0, mint_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::mint | invalid authorization signature');
