...
module.exports = {
    mint_invalid_nums: async function mint_invalid_nums() {
        ...
        await expect(T721Controller.verifyMint(id, 0, err_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::verifyMint | invalid nums length');
        return expect(T721Controller.mint(id, 0, err_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::mint | invalid nums length');
