...
module.exports = {
    fixAttachments_erc20_invalid_addr_length: async function fixAttachment_erc20_invalid_addr_length() {
        ...
        await expect(T721AttachmentsController.verifyAttachments(ticket_id, att_names, att_test_nums, err_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachmentPayment | invalid addr argument count');
        return expect(T721AttachmentsController.fixAttachments(ticket_id, att_names, att_nums, err_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::processAttachmentPayment | invalid addr argument count');
    }
};
