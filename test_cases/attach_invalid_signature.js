...
module.exports = {
    attach_invalid_signature: async function attach_invalid_signature() {
        ...
        uints[uints.length - 2] = 123;

        await expect(T721Controller.attach(id, b32, uints, addr, bs)).to.eventually.be.rejectedWith('T721C::attach | invalid signature');
