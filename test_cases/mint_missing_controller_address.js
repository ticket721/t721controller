...
module.exports = {
    mint_missing_controller_address: async function mint_missing_controller_address() {
        ...
        await expect(T721Controller.mint(id, b32, uints, [], bs)).to.eventually.be.rejectedWith('T721C::mint | missing addr[0] (event controller)');
