...
module.exports = {
    registerCategories_from_admin: async function registerCategories_from_admin() {
        ...
        const receipt = await T721Controller.registerCategories(id, nums, addr, byte_data, {gas: gasLimit, from: accounts[2]});
