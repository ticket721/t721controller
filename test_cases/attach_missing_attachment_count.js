...
module.exports = {
    attach_missing_attachment_count: async function attach_missing_attachment_count() {
        ...
        await expect(T721Controller.attach(id, b32, uints.slice(0, 1 + (payments.length * 2)), addr, bs)).to.eventually.be.rejectedWith('T721C::attach | missing attachmentCount on uints');
