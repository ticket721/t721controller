...
module.exports = {
    attach_missing_uints_for_payment: async function attach_missing_uints_for_payment() {
        ...
        await expect(T721Controller.attach(id, b32, uints.slice(0, 1), addr, bs)).to.eventually.be.rejectedWith('T721C::attach | not enough space on uints (1)');
