...
module.exports = {
    registerCategories_invalid_nums: async function registerCategories_invalid_nums() {
        ...
        const err_nums = nums.slice(0, nums.length - 1);
        const gasLimit = (await web3.eth.getBlock("latest")).gasLimit;

        return expect(T721Controller.registerCategories(id, err_nums, addr, byte_data, {gas: gasLimit})).to.eventually.be.rejectedWith('T721C::checkCategoryInfos | invalid nums argument count');
