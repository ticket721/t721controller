...
module.exports = {
    mint_missing_uints_for_minting: async function mint_missing_uints_for_minting() {
        ...
        await expect(T721Controller.mint(id, b32, uints.slice(0, 3 + (payments.length * 2)), addr, bs)).to.eventually.be.rejectedWith('T721C::mint | not enough space on uints (2)');
