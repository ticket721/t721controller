...
module.exports = {
    registerCategories_disable_resale: async function registerCategories_disable_resale() {
        ...
        for (let idx = 0; idx < amount; ++idx) {
            ...
            expect(recovered.resale_start.toNumber()).to.equal(0);
            expect(recovered.resale_end.toNumber()).to.equal(0);
