const { Authorizer, generateMintPayload, generateAttachPayload } = require('../test/utils');
const { T721C_CONTRACT_NAME } = require('../test/constants');
const { Wallet } = require('ethers');

// Mint 5 tickets, with 2 currencies
module.exports = {
    attach_missing_signature_for_attachment: async function attach_missing_signature_for_attachment() {
        ...
        await expect(T721Controller.attach(id, b32, uints, addr, '0x')).to.eventually.be.rejectedWith('T721C::attachment | not enough space or invalid length on bs');
