...
module.exports = {
    mint_erc2280_invalid_sig_size: async function mint_erc2280_invalid_sig_size() {
        ...
        await expect(T721CE.functions.verifyMint(id, 0, mint_nums, mint_addr, err_sig)).to.eventually.be.rejectedWith('T721C::verifyERC2280Payment | invalid signature size');
        return expect(T721CE.functions.mint(id, 0, mint_nums, mint_addr, err_sig, {gasLimit: 3000000})).to.eventually.be.rejectedWith('T721C::processERC2280Payment | invalid signature size');
