...
module.exports = {
    registerCategories_invalid_currency: async function registerCategories_invalid_currency() {
        ...
        return expect(T721Controller.registerCategories(id, nums, addr, byte_data, {gas: gasLimit})).to.eventually.be.rejectedWith('T721C::registerCategories | unauthorized currency added');
