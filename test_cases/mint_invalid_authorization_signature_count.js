...
module.exports = {
    mint_invalid_authorization_signature_count: async function mint_invalid_authorization_signature_count() {
        ...
        const err_sig = mint_sig.slice(0, mint_sig.length - 65);
        ...
        await expect(T721Controller.verifyMint(id, 0, mint_nums, mint_addr, err_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::verifyMint | invalid authorization signature count');
        return expect(T721Controller.mint(id, 0, mint_nums, mint_addr, err_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::mint | invalid authorization signature count');
