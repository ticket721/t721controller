...
module.exports = {
    registerCategories_invalid_resale_start: async function registerCategories_invalid_resale_start() {
        ...
        return expect(T721Controller.registerCategories(id, nums, addr, byte_data, {gas: gasLimit})).to.eventually.be.rejectedWith('T721C::checkTimestamps | resale start is in the past');
