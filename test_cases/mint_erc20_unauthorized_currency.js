...
module.exports = {
    mint_erc20_unauthorized_currency: async function mint_erc20_unauthorized_currency() {
        ...
        await expect(T721Controller.verifyMint(id, 0, mint_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::verifyERC20MintPayment | unauthorized erc20 currency');
        return expect(T721Controller.mint(id, 0, mint_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::processERC20MintPayment | unauthorized erc20 currency');
    }
};
