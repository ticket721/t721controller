...
module.exports = {
    registerCategories_from_unauthorized: async function registerCategories_from_unauthorized() {
        ...
        return expect(T721Controller.registerCategories(id, nums, addr, byte_data, {gas: gasLimit, from: accounts[2]})).to.eventually.be.rejectedWith('T721C::groupOwnerOrAdminOnly | unauthorized tx sender');
