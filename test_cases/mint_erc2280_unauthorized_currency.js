...
module.exports = {
    mint_erc2280_unauthorized_currency: async function mint_erc2280_unauthorized_currency() {
        ...
        await expect(T721CE.functions.verifyMint(id, 0, mint_nums, mint_addr, mint_sig)).to.eventually.be.rejectedWith('T721C::verifyERC2280MintPayment | unauthorized erc2280 currency');
        return expect(T721CE.functions.mint(id, 0, mint_nums, mint_addr, mint_sig, {gasLimit: 3000000})).to.eventually.be.rejectedWith('T721C::processERC2280MintPayment | unauthorized erc2280 currency');
