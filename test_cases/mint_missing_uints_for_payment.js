...
module.exports = {
    mint_missing_uints_for_payment: async function mint_missing_uints_for_payments() {
        ...
        await expect(T721Controller.mint(id, b32, uints.slice(0, 1), addr, bs)).to.eventually.be.rejectedWith('T721C::mint | not enough space on uints (1)')
