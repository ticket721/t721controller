...
module.exports = {
    attach_missing_addr_for_payment: async function attach_missing_addr_for_payment() {
        ...
        await expect(T721Controller.attach(id, b32, uints, addr.slice(0, 1), bs)).to.eventually.be.rejectedWith('T721C::attach | not enough space on addr (1)');
