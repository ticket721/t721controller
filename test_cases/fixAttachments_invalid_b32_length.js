...
module.exports = {
    fixAttachments_invalid_b32_length: async function fixAttachment_invalid_b32_length() {
        ...
        await expect(T721AttachmentsController.verifyAttachments(ticket_id, err_b32, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | invalid b32 arguments length');
