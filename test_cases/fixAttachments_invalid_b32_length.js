...
module.exports = {
    fixAttachments_invalid_b32_length: async function fixAttachment_invalid_b32_length() {
        ...
        const err_b32 = [att_names[0]];
        await expect(T721AttachmentsController.verifyFixAttachments(ticket_id, err_b32, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | invalid b32 arguments length');
        return expect(T721AttachmentsController.fixAttachments(ticket_id, err_b32, att_nums, att_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::fixAttachments | invalid b32 arguments length');
