...
module.exports = {
    attach_for_free: async function attach_for_free() {
        ...
        const expiration = new Date(Date.now() + 60000);
        const [id, b32, uints, addr, bs] = await generateAttachPayload(uuid, [], attachments, expiration, eventControllerWallet, accounts[9], signer);
