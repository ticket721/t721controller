...
module.exports = {
    fixAttachments_erc20_allowance_too_low: async function fixAttachment_erc20_allowance_too_low() {
        ...
        await ERC20.approve(T721AttachmentsController.address, 1200, {from: accounts[0]});
        await expect(T721AttachmentsController.verifyFixAttachments(ticket_id, att_names, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | erc20 allowance too low');
        return expect(T721AttachmentsController.fixAttachments(ticket_id, att_names, att_nums, att_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejected;
    }
};
