...
module.exports = {
    fixAttachments_erc20_allowance_too_low: async function fixAttachment_erc20_allowance_too_low() {
        ...
        await expect(T721AttachmentsController.verifyAttachments(ticket_id, att_names, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | erc20 allowance too low');
