...
module.exports = {
    fixAttachments_erc20_invalid_nums_length: async function fixAttachment_erc20_invalid_nums_length() {
        ...
        await expect(T721AttachmentsController.verifyFixAttachments(ticket_id, att_names, err_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyERC20AttachmentPayment | invalid nums argument count');
        return expect(T721AttachmentsController.fixAttachments(ticket_id, att_names, err_nums, att_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::processERC20AttachmentPayment | invalid nums argument count');
    }
};
