...
module.exports = {
    fixAttachments_invalid_category_idx: async function fixAttachment_invalid_category_idx() {
        ...
        await expect(T721AttachmentsController.verifyAttachments(ticket_id, att_names, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | invalid category_idx');
