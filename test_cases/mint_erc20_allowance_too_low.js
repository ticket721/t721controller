...
module.exports = {
    mint_erc20_allowance_too_low: async function mint_erc20_allowance_too_low() {
        ...
        await expect(T721Controller.verifyMint(id, 0, mint_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::verifyERC20Payment | erc20 allowance too low');
