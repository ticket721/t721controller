...
module.exports = {
    fixAttachments_invalid_ticket_id: async function fixAttachment_invalid_ticket_id() {
        ...
        await expect(T721AttachmentsController.verifyAttachments(ticket_id + 1000, att_names, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | invalid ticket id');
