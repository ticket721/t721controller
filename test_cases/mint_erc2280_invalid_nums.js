...
module.exports = {
    mint_erc2280_invalid_nums: async function mint_erc2280_invalid_nums() {
        ...
        await expect(T721CE.functions.verifyMint(id, 0, err_nums, mint_addr, mint_sig)).to.eventually.be.rejectedWith('T721C::verifyERC2280Payment | invalid number of nums arguments');
        return expect(T721CE.functions.mint(id, 0, err_nums, mint_addr, mint_sig, {gasLimit: 3000000})).to.eventually.be.rejectedWith('T721C::processERC2280Payment | invalid number of nums arguments');
