...
module.exports = {
    mint_missing_addr_for_minting: async function mint_missing_addr_for_minting() {
        ...
        await expect(T721Controller.mint(id, b32, uints, addr.slice(0, 1 + payments.length), bs)).to.eventually.be.rejectedWith('T721C::mint | not enough space on addr (2)');
