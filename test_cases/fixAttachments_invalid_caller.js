...
module.exports = {
    fixAttachments_invalid_caller: async function fixAttachment_invalid_caller() {
        ...
        await expect(T721AttachmentsController.verifyAttachments(ticket_id + 1, att_names, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | caller is not ticket owner');
