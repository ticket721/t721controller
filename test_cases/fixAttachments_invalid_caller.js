...
module.exports = {
    fixAttachments_invalid_caller: async function fixAttachment_invalid_caller() {
        ...
        await expect(T721AttachmentsController.verifyFixAttachments(ticket_id + 1, att_names, att_test_nums, att_test_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | caller is not ticket owner');
        return expect(T721AttachmentsController.fixAttachments(ticket_id + 1, att_names, att_nums, att_addr, att_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::fixAttachments | caller is not ticket owner')
