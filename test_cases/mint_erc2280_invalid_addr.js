...
module.exports = {
    mint_erc2280_invalid_addr: async function mint_erc2280_invalid_addr() {
        ...
        await expect(T721CE.functions.verifyMint(id, 0, mint_nums, err_addr, mint_sig)).to.eventually.be.rejectedWith('T721C::verifyERC2280Payment | invalid number of addr arguments');
        return expect(T721CE.functions.mint(id, 0, mint_nums, err_addr, mint_sig, {gasLimit: 3000000})).to.eventually.be.rejectedWith('T721C::processERC2280Payment | invalid number of addr arguments');
