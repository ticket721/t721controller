...
module.exports = {
    mint_invalid_signature: async function mint_invalid_signature() {
        ...
        await expect(T721Controller.mint(id, b32, uints, addr, bs)).to.eventually.be.rejectedWith('T721C::mint | invalid signature');
