...
module.exports = {
    mint_payment_score_too_low: async function mint_payment_score_too_low() {
        ...
        await expect(T721Controller.verifyMint(id, 0, mint_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::verifyMint | payment score too low');
        return expect(T721Controller.mint(id, 0, mint_nums, mint_addr, mint_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721C::mint | payment score too low');
