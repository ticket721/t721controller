...
module.exports = {
    registerCategories_invalid_byte_data: async function registerCategories_invalid_byte_data() {
        ...
        const err_byte_data = byte_data.slice(1);
        const gasLimit = (await web3.eth.getBlock("latest")).gasLimit;

        return expect(T721Controller.registerCategories(id, nums, addr, err_byte_data, {gas: gasLimit})).to.eventually.be.rejectedWith('T721C::checkCategoryInfos | invalid byte_data argument count');
    }
};
