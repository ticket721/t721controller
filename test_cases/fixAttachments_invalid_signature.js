...
module.exports = {
    fixAttachments_invalid_signature: async function fixAttachment_invalid_signature() {
        ...
        await expect(T721AttachmentsController.verifyAttachments(ticket_id, att_names, att_test_nums, att_test_addr, err_sig, {from: accounts[0]})).to.eventually.be.rejectedWith('T721AC::verifyAttachments | invalid attachment authorization signature');
