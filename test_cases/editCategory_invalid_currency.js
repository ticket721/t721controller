...
module.exports = {
    editCategory_invalid_currency: async function editCategory_invalid_currency() {
        ...
        return expect(T721Controller.editCategory(id, 0, edit_nums, auth, attachment, hierarchy, prices, currencies)).to.be.rejectedWith('T721C::editCategory | unauthorized currency');
    }
};
